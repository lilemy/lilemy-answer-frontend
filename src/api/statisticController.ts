...
export async function getAppAnswerCount(options?: { [key: string]: any }) {
  return request<API.BaseResponseListAppAnswerCountVO>('/statistic/answer/count', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function getAppAnswerResultCount(
  ...
  return request<API.BaseResponseAppAnswerResultCountVO>('/statistic/answer/result/count', {
    method: 'GET',
    params: {
      ...params,
    },
